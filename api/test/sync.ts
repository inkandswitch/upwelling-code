...
describe('save and load', () => {
  ...
  it('merges all drafts on an upwell', async () => {
    ...
    let bauthor = {
      id: createAuthorId(),
      name: 'Bon Bacob Bingleheimer Schmibt',
    }
